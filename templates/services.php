...
<main>
  <div class="hero">
    <div class="container">
      ...
      <p class="lead">Webservice Studio надає чотири послуги: розробку сайтів, Android-застосунків, інструменти для арбітражу трафіку (вайтпейдж, лендинги, клоакінг) та адміністрування доменів і хостингу. Орієнтовні ціни — на сторінці «Ціни», фінальну вартість погоджуємо після короткого брифу.</p>
    </div>
  </div>
